...
latex_documents = [
    (master_doc, "Pyalect.tex", "Pyalect Documentation", "Ryan Morshead", "manual")
]
...
man_pages = [(master_doc, "pyalect", "Pyalect Documentation", [author], 1)]
